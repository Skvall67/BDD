...
Функционал: Документы ДЛКО
  ...
  Структура сценария: проверка создания нового документа «Документ о списании актива» к активу
    ...
    Если пользователь (открыл экранную форму) "Ввод договора об утилизации актива"
    Если пользователь (заполняет поле) "Номер договора об утилизации" "<Номер договора об утилизации>"
    Если пользователь (заполняет поле) "Дата договора об утилизации актива" "<Дата договора об утилизации актива>"
    Если пользователь (нажимает на кнопку) "Выбрать3"
    Если пользователь (открыл экранную форму) "Выбор документа"
    Если пользователь (выделяет строку) "Документ о списании актива"
    Если пользователь (нажимает на кнопку) "Выбрать2"
    Если пользователь (открыл экранную форму) "Ввод договора об утилизации актива"
    Если пользователь (заполняет поле) "Контрагент" "<Контрагент>"
    Если пользователь (нажимает на кнопку) "Сохранить"
    Если пользователь (открыл экранную форму) "Документы ДЛКО"
    Если пользователь (выделяет строку) "<Номер лицевого счета тестового актива>"
    Если пользователь (проверяет созданный документ) "<Номер договора об утилизации>"
    Если пользователь (нажимает на кнопку) "Сделать таблицу первичной"
    Если пользователь (нажимает на кнопку) "Да"
    Если пользователь (устанавливает чек-бокс) "<Номер договора об утилизации>"
    ...
    Примеры:
      |Номер лицевого счета тестового актива| Номер договора об утилизации | Дата договора об утилизации актива | Контрагент |
      |45507810188880000010                 | 124482                       | 06.07.2017                         | Контрагент |